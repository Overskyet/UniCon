...
public class FuelConsumptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.fuel_consumption_block,R.layout.spinner_item);
    ...
    protected void onResume() {
        ...
        if (firstLaunch.getBoolean(FIRST_LAUNCH, true)) {
            ...
            spinner2.setSelection(mySettingsForSpinners.getInt(SPINNER_2_PREFERENCE_KEY, 3));
    ...
    private void conversion() {
        ...
        double output = FuelConsumptionMethods.convert(inputValue, spinnerItemName, spinner2ItemName);
