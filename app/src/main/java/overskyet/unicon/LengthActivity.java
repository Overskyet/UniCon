...
public class LengthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.length_block,R.layout.spinner_item);
    ...
    protected void onResume() {
        ...
        if (firstLaunch.getBoolean(FIRST_LAUNCH, true)) {
            ...
            spinner.setSelection(mySettingsForSpinners.getInt(SPINNER_1_PREFERENCE_KEY, 2));
            spinner2.setSelection(mySettingsForSpinners.getInt(SPINNER_2_PREFERENCE_KEY, 9));
    ...
    private void conversion() {
        ...
        double output = LengthMethods.convert(inputValue, spinnerItemName, spinner2ItemName);
